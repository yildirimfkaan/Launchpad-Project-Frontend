...
export default function Contract() {
  ...
  }, [contractInfo.address],[isLoading]);
  ...
  const getMyBalance_data = [getMyBalance,balanceInfo,isLoading]
        ...
        <form className="m-4" onSubmit={handleSubmit}>
          <div className="credit-card w-full lg:w-3/4 sm:w-auto shadow-lg mx-auto rounded-xl bg-white">
            ...
            <footer className="p-4">
              <button
                type="submit"
                className="btn btn-primary submit-button focus:ring focus:outline-none w-full" disabled={isLoading}
              >
            ...
            {getMyBalanceStatus ? <GetMyBalance {...getMyBalance_data}/> :<div> </div>}
          </div>
        </form>
        
      </Col>
      <Col >
        {TransferStatus ?  <Transfer {...Transfer_data}/>:<div> </div>}
      </Col>
