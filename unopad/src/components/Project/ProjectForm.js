...
import { addProjectAction } from '../../store/account/actions/projectActions'
...
class ProjectForm extends Component {
    ...
    handleSubmit = (e) => {
        e.preventDefault()
        const { project_name, project_number_of_participants, project_number_of_registrations } = this.state
    ...
    render() {
        const { project_name, project_number_of_participants, project_nameErr, project_number_of_participantsErr , project_number_of_registrations,
        project_number_of_registrationsErr} = this.state

        return (
            <Form onSubmit={this.handleSubmit} >
                <FormGroup>
                    <Label htmlFor="project_name">project_name</Label>
                    <Input id="project_name" value={project_name} onChange={this.handleChange} />
                ...
                <FormGroup>
                    <Label htmlFor="project_number_of_participants">project_number_of_participants</Label>
                    <Input id="project_number_of_participants" value={project_number_of_participants} onChange={this.handleChange} />
                ...
                <FormGroup>
                    <Label htmlFor="project_number_of_registrations">project_number_of_registrations</Label>
                    <Input id="project_number_of_registrations" value={project_number_of_registrations} onChange={this.handleChange} />
