...
!(function (t, e) {
  ...
  var tt = {
    ...
    et = {
      ...
      find: function (t, e) {
        var n;
        return (
          void 0 === e && (e = document.documentElement), (n = []).concat.apply(n, O.call(e, t))
        );
      },
    ...
    at = (function () {
      ...
      return (
        ...
        (n.pause = function (t) {
          t || (this._isPaused = !0),
            et.findOne('.carousel-item-next, .carousel-item-prev', this._element) &&
        ...
        (n._getItemIndex = function (t) {
          return (
            (this._items = t && t.parentNode ? et.find('.carousel-item', t.parentNode) : []),
      ...
      return (
        ...
        (n.show = function () {
          ...
          if (!this._isTransitioning && !this._element.classList.contains('show')) {
            ...
            this._parent &&
              0 ===
                (n = et.find('.show, .collapsing', this._parent).filter(function (t) {
        ...
        (t.collapseInterface = function (e, n) {
          ...
          if (
            (!i && r.toggle && 'string' == typeof n && /show|hide/.test(n) && (r.toggle = !1),
            i || (i = new t(e, r)),
            'string' == typeof n)
          ) {
  ...
  function Ct(t) {
    ...
    return i && 'BODY' !== i && 'HTML' !== i
      ? -1 !== ['TH', 'TD', 'TABLE'].indexOf(n.nodeName) && 'static' === yt(n, 'position')
        ? Ct(n)
        : n
      : t
  ...
  function qt(t, e, n, i) {
    ...
    if ('viewport' === i) r = Ut(s, o);
      ...
      var a = void 0;
      'scrollParent' === i
        ? 'BODY' === (a = Et(wt(e))).nodeName && (a = t.ownerDocument.documentElement)
  ...
  function se() {
    this.state.eventsEnabled ||
      (this.state = re(this.reference, this.options, this.state, this.scheduleUpdate));
  }
  function ae() {
    var t, e;
    this.state.eventsEnabled &&
        ...
        arrow: {
          ...
          fn: function (t, e) {
            ...
            return (
              ...
              (t.arrowElement = i),
              (t.offsets.arrow = (Ht((n = {}), f, Math.round(b)), Ht(n, h, ''), n)),
              t
            );
          },
          element: '[x-arrow]',
  ...
  var we = 'dropdown',
    ...
    ke = (function () {
      ...
      return (
            ...
            if (!V.trigger(this._element, 'show.bs.dropdown', n).defaultPrevented) {
              if (!this._inNavbar) {
                ...
                'parent' === this._config.reference
                  ...
                  (this._popper = new ye(i, this._menu, this._getPopperConfig()));
              }
              var o;
        ...
        (n._getConfig = function (t) {
          return (
            (t = o(o(o({}, this.constructor.Default), tt.getDataAttributes(this._element)), t)),
  ...
  V.on(
    ...
    V.on(document, 'keydown.bs.dropdown.data-api', '.dropdown-menu', ke.dataApiKeydownHandler),
      ...
      return (
        ...
        (n._resetScrollbar = function () {
          et.find('.fixed-top, .fixed-bottom, .is-fixed, .sticky-top').forEach(function (t) {
            ...
            void 0 !== e &&
              (tt.removeDataAttribute(t, 'padding-right'), (t.style.paddingRight = e));
          }),
            et.find('.sticky-top').forEach(function (t) {
              var e = tt.getDataAttribute(t, 'margin-right');
              void 0 !== e &&
                (tt.removeDataAttribute(t, 'margin-right'), (t.style.marginRight = e));
            });
        ...
        a = function (t, n) {
          ...
          l.forEach(function (t) {
            (function (t, e) {
              ...
              if (-1 !== e.indexOf(n))
                return (
                  -1 === Ie.indexOf(n) || Boolean(t.nodeValue.match(je) || t.nodeValue.match(Pe))
                );
              for (
    ...
    qe = (function () {
      ...
      return (
          ...
          if (this._isEnabled)
            if (t) {
              var e = this.constructor.DATA_KEY,
                n = L(t.target, e);
              n ||
                ((n = new this.constructor(t.target, this._getDelegateConfig())),
                T(t.target, e, n)),
        ...
        (n.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            if (
              ...
              (this._popper = new ye(this.element, o, this._getPopperConfig(a))),
        ...
        (n.setContent = function () {
          ...
          this.setElementContent(et.findOne('.tooltip-inner', t), this.getTitle()),
        ...
        (n._getOffset = function () {
          ...
          return (
            'function' == typeof this.config.offset
              ? (e.fn = function (e) {
                  return (
                    (e.offsets = o(o({}, e.offsets), t.config.offset(e.offsets, t.element) || {})),
                    e
                  );
                })
        ...
        (n._setListeners = function () {
          ...
          this.config.trigger.split(' ').forEach(function (e) {
            ...
            this.config.selector
              ? (this.config = o(o({}, this.config), {}, { trigger: 'manual', selector: '' }))
              : this._fixTitle();
        }),
        ...
        (n._enter = function (t, e) {
          ...
          (e = e || L(t.target, n)) ||
            ((e = new this.constructor(t.target, this._getDelegateConfig())), T(t.target, n, e)),
        ...
        (o.jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              ...
              (e || ((e = new o(this, n)), T(this, 'bs.popover', e)), 'string' == typeof t)
            ) {
  ...
  var nn = 'scrollspy',
    ...
    sn = (function () {
      ...
      return (
        ...
        (n._getConfig = function (t) {
          if (
            'string' != typeof (t = o(o({}, on), 'object' == typeof t && t ? t : {})).target &&
            m(t.target)
          ) {
            var e = t.target.id;
        ...
        (n._activate = function (t) {
          ...
          n.classList.contains('dropdown-item')
            ? (et.findOne('.dropdown-toggle', n.closest('.dropdown')).classList.add('active'),
    ...
    return (
      (n.show = function () {
        ...
        if (
          ...
          var r = null;
          if (
            (e && (r = V.trigger(e, 'hide.bs.tab', { relatedTarget: this._element })),
            !(
