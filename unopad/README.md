...
Download the Installer from NodeJs official website. Make sure you have downloaded the latest version of NodeJs(v18.1.0 recommended for this project).
...
### `npm run start` or `npm run start --force`
